...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 1) create a post and add to firestore collections'
    // 2) get the post ID for the newly created post
    // 3) upload the image with firebase storage with the post ID
      ...
      >
       ...
       sm:block sm:p-0"
        >
          ...
          {/* this element is to trick the browser into centering the modalcontent */}
          <span
          ...
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
            enterFrom="opacity-0 translatex-y-4  sm:translate-y-0 sm:scale-95"
          ...
          >
            <div
              className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8
